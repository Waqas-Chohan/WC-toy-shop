            ...
            <div className="space-y-2 md:col-span-2">
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                <input
                  ...
                  className="flex-1 h-10 px-3 rounded-lg bg-secondary/50 border border-border text-sm text-white focus:outline-none focus:border-purple-500 transition-colors"
                  required
                />
